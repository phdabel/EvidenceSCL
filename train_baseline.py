...
def main_worker(gpu, args):
    ...
    for epoch in range(args.epochs):
        ...
        if args.dataset == 'nli4ct':
            train_semeval_maj_acc, \
                train_semeval_at_least_one_acc, \
                train_agg_results = compute_real_accuracy(train_result, args, 'training')
            ...
            val_semeval_maj_acc, \
                val_semeval_at_least_one_acc, \
                val_agg_results = compute_real_accuracy(val_result, args, 'validation')
