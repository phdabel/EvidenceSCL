...
from data_processor import MedNLIPreprocessor


def preprocess_mednli_data(inputdir,
                           targetdir,
                           lowercase=False,
                           ...
                           eos=None):
    """
    Preprocess the data from the MedNLI dataset so it can be used by the
    ESIM model.
    ...
    Args:
        inputdir: The path to the directory containing the MedNLI dataset.
    ...
    preprocessor = MedNLIPreprocessor(lowercase=lowercase,
...
if __name__ == "__main__":
    default_config = "../config/mednli_preprocessing.json"
