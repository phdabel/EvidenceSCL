...
from preprocessing.preprocess_semeval import convert_examples_to_features
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'SEMEVAL23':
        ...
        validate_dataset = convert_examples_to_features(dev_data, tokenizer=tokenizer, max_length=args.max_length)
        if args.distributed:
