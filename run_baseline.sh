...
# ----------------------------------
# learning_rate = 1e-5
python train_baseline.py --dataset mednli --max_seq_length 128 --num_classes 3 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 1e-5
python train_baseline.py --dataset mednli --max_seq_length 512 --num_classes 3 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 1e-5
python train_baseline.py --dataset mednli --max_seq_length 128 --num_classes 2 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 1e-5
python train_baseline.py --dataset mednli --max_seq_length 512 --num_classes 2 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 1e-5
# learning_rate = 3e-5
python train_baseline.py --dataset mednli --max_seq_length 128 --num_classes 3 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 3e-5
python train_baseline.py --dataset mednli --max_seq_length 512 --num_classes 3 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 3e-5
python train_baseline.py --dataset mednli --max_seq_length 128 --num_classes 2 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 3e-5
python train_baseline.py --dataset mednli --max_seq_length 512 --num_classes 2 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 3e-5
# learning_rate = 5e-5
python train_baseline.py --dataset mednli --max_seq_length 128 --num_classes 3 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 5e-5
python train_baseline.py --dataset mednli --max_seq_length 512 --num_classes 3 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 5e-5
python train_baseline.py --dataset mednli --max_seq_length 128 --num_classes 2 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 5e-5
python train_baseline.py --dataset mednli --max_seq_length 512 --num_classes 2 --model_name biomed --batch_size 32 --gradient_accumulation_steps 16 --epochs 10 --workers 2 --learning_rate 5e-5